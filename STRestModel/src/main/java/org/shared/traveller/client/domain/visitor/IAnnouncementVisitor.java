...
{
	/**
	 * The method visits the specified announcement
	 * so that some business behaviour can be dynamically added
	 * to this instance
	 *
	 * @param inAnnouncement the client domain announcement to be visited
	 */
