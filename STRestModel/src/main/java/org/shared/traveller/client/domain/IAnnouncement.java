...
public interface IAnnouncement extends Serializable
{
	...
	{
		/**
		 * The method sets the new value for the departure time
		 * of the built announcement
		 *
		 * @param inDepTime the new departure time value
		 * @return the builder used
		 */
		AnnouncementBuilder depTime(final Date inDepTime);

		/**
		 * The method sets the new value for the price
		 * of the built announcement
		 *
		 * @param inPrice the new price value
		 * @return the builder used
		 */
		AnnouncementBuilder price(final BigDecimal inPrice);

		/**
		 * The method sets the new value for the departure address
		 * of the built announcement
		 *
		 * @param inPrice the new departure address value
		 * @return the builder used
		 */
		AnnouncementBuilder depAddress(final String inDepAddress);

		/**
		 * The method sets the new value for the name of the vehicle
		 * of the built announcement
		 *
		 * @param inPrice the new vehicle name
		 * @return the builder used
		 */
		AnnouncementBuilder vehicleName(final String inVehName);

		/**
		 * The method sets the new value for the status
		 * of the built announcement
		 *
		 * @param inStatus the new status value
		 * @return the builder used
		 */
        AnnouncementBuilder status(final Status inStatus);

		/**
		 * The method sets the new intermediate points for
		 * the built announcement
		 *
		 * @param inIntermediatePts the new intermediate points
		 * @return the builder used
		 */
