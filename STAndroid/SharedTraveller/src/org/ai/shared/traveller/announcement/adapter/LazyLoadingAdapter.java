...
public class LazyLoadingAdapter extends EndlessAdapter
{
    ...
    public LazyLoadingAdapter(final Context ctxt,
            final ArrayList<Announcement> list,
            final IAdapterHttpTask<ServerResponse<AnnouncementsList>> httpTask)
    {
        super(ctxt, new ArrayAdapter<Announcement>(ctxt,
            ...
            final ViewGroup parent)
    {
        ...
        if (item != null)
        {
            ...
            final RowButtonComposer composer = new RowButtonComposer(
    ...
    {
        final ServerResponse<AnnouncementsList> response = executeRestRequest(position);
    ...
    // method.
    private ServerResponse<AnnouncementsList> executeRestRequest(
