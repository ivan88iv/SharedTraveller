...
public abstract class AbstractNetworkTask<Result> extends
        AsyncTask<Void, Void, ServerResponse<Result>>
{
    ...
    private final ServerResponseParser<Result> parser = new ServerResponseParser<Result>();
            ...
            throws ServiceConnectionException
    {
        ...
        } catch (final MalformedURLException murle)
        {
            throw new ServiceConnectionException(
                    MessageFormat.format(INCORRECT_URL, inUrl), murle);
        }
    ...
    protected ServerResponse<Result> doInBackground(final Void... params)
    {
        ...
        try
        {
            restClient.callService(requestAddress, parser);
