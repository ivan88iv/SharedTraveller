...
ALTER TABLE NOTIFICATION ADD INDEX FKNOTIFICATI182123 (ANOUNCMENT_ID), ADD CONSTRAINT FKNOTIFICATI182123 FOREIGN KEY (ANOUNCMENT_ID) REFERENCES ANNOUNCEMENT (ID);
