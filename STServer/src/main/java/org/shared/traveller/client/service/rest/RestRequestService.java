...
public class RestRequestService
{
	...
	@ResponseBody
	public ResponseEntity<RequestList> getUserRequests(@RequestParam(value = "start") final Long inStartIndex,
			@RequestParam(value = "count") final Long inCount)
	{
		...
		RequestList userRequests = requestService.getUserRequests(inUser, inStartIndex.intValue(), inCount.intValue());
