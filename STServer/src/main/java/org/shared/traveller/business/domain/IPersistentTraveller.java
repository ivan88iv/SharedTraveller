...
public interface IPersistentTraveller extends IPersistent
{
	...
	/**
	 * Returns true if sms notifications can be accepted by the traveller
	 * 
	 * @return true if sms notifications can be accepted by the traveller
	 */
	boolean getSmsNotifications();

	/**
	 * Returns true if email notifications can be accepted by the traveller
	 * 
	 * @return true if email notifications can be accepted by the traveller
	 */
