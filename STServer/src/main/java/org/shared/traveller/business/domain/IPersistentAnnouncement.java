...
/**
 * The interface represents the functionality a persistent announcement should
 * possess
 * 
 * @author "Ivan Ivanov"
 * 
...
public interface IPersistentAnnouncement extends IPersistent
{
	 ...
	 * 
	 * @param inSeats
	 *            the new value of the free seats
	 */
	...
	/**
	 * Returns the intermediate settlements the travel will go through( if any)
	 * 
	 * @return the intermediate settlements the travel will go through( if any)
	 */
	List<? extends IPersistentCity> getIntermediatePoints();

	/**
	 * Returns the requests for this announcement
	 * 
	 * @return the requests for this announcement
	 */
	List<? extends IPersistentRequest> getRequests();
}
