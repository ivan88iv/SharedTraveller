...
{
	/**
	 * The method creates a new persistent request instance and saves it.
	 * 
	 * @param inSender
	 *            the sender of the request. It may not be null.
	 * @param inAnnouncement
	 *            the announcement for which a request is sent. It may not be
	 *            null.
	 * 
	 * @throws DataModificationException
	 *             if an error occurs while trying to save the new request
	 */
	void saveNewRequest(final IPersistentTraveller inSender, final IPersistentAnnouncement inAnnouncement)
			throws DataModificationException;
