		...
		extends IDAO<IPersistentGenericNotification>
{
	...
	/**
	 * Returns all generic notification instances currently persisted
	 * 
	 * @return all generic notification instances currently persisted
	 * 
	 * @throws DataExtractionException
	 *             if a problem occurs while trying to obtain all generic
	 *             notifications from the persistent layer
	 */
	List<? extends IPersistentGenericNotification> getAll();
}
